...
async def get_map(auth_token: str = Depends(oauth2_scheme)):
    ...
    json_other = [
        {"type": "divider", "start": {"x": 1, "y": 66}, "end": {"x": 98, "y": 66}},
        {"type": "divider", "start": {"x": 1, "y": 132}, "end": {"x": 98, "y": 132}},
        {"type": "divider", "start": {"x": 114, "y": 66}, "end": {"x": 210, "y": 66}},
        {"type": "divider", "start": {"x": 114, "y": 132}, "end": {"x": 211, "y": 132}},
        {"type": "road", "start": {"x": 0, "y": 134}, "end": {"x": 212, "y": 146}},
        {"type": "road", "start": {"x": 2, "y": 93}, "end": {"x": 210, "y": 105}},
        {"type": "road", "start": {"x": 2, "y": 27}, "end": {"x": 210, "y": 39}},
        {"type": "road", "start": {"x": 2, "y": 93}, "end": {"x": 210, "y": 105}},
        {"type": "road", "start": {"x": 100, "y": 0}, "end": {"x": 112, "y": 146}},
        {
            "type": "gate",
            "name": "1",
            "start": {"x": 100, "y": -1},
