...
<div
  class="cursor-pointer flex flex-col items-center justify-center rounded hover:scale-105 transition-transform shadow-md hover:shadow-lg z-10 backdrop-blur-sm text-sm md:text-base"
  role="button"
  tabindex="0"
  on:click
  {style}
